class IndiesWiki::HomeController < ApplicationController
  ...
  def show
    ...
    @tags = %w(おしゃれさん 電子音 シュッとしてる おじさん おさけ パワーポップ)
    @areas = %w(高崎 大塚 うつのみや 東京)
  end
end
